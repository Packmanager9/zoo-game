...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function setUp(canvas_pass, style = "#000000") {
        ...
        window.addEventListener('pointerdown', e => {
            ...
            if (sandmap.window.UI.roadButton.isPointInside(TIP_engine)  &&  sandmap.window.UI.beDrawn == -1) {
                ...
                if (sandmap.window.UI.toggle.isPointInside(TIP_engine)) {
                    ...
                    selectrect = new Tile(rectstart.x * 10, rectstart.y * 10, (structuredpoint.x1 - rectstart.x) * 10, (structuredpoint.y1 - rectstart.y) * 10, "#00FFFF" + "22")
        ...
        function continued_stimuli(e) {
            ...
            if (sandmap.window.UI.roadButton.isPointInside(TIP_engine)) {
                ...
                if (sandmap.window.UI.toggle.isPointInside(TIP_engine)) {
                    ...
                    selectrect = new Tile((rectstart.x * 10)+xshifter, (rectstart.y * 10)+ yshifter, ((structuredpoint.x1 - rectstart.x) * 10),( (structuredpoint.y1 - rectstart.y) * 10) , "#0088AA" + "94")
    ...
    class Sandmap {
        ...
        draw() {
            ...
            let rect = new Tile(0, 0, 2560, 2560, inputbox.value)
            // for (let t = 0; t < this.blocks.length; t++) {
            //     for (let k = 0; k < this.blocks[t].length; k++) {
    ...
    class Hopo {
        ...
        calc() {
            ...
            for (let t = 0; t < this.tail.length; t++) {
                ...
                if (t > 0) {
                    if (Math.abs(this.body.set[0]) + Math.abs(this.body.set[1]) > 0) {
                        this.tail[t].angle = ((this.tail[t - 1].angle * 1.05) + (this.tail[t].angle * 1)) / 2.05
                    }
        ...
        draw() {
            ...
            if (this.selected == 1) {
                ...
                if (sandmap.window.UI.beDrawn == -1) {
                    ...
                    canvas_context.lineWidth = 1.5
                    canvas_context.font = "18px arial"
                    canvas_context.strokeText("Animals: " + this.animals.length, sandmap.window.minibody.x, 20)
                    canvas_context.fillText("Animals: " + this.animals.length, sandmap.window.minibody.x, 20)
                    for (let t = 0; t < this.animals.length; t++) {
